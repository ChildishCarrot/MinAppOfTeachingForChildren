...
//     */
//
//    public work.huangxin.mango.util.login.IsLogin isTrue(MangoUser mangoUser, String openid, MangoUserService mangoUserService) {
//        MangoUser mangoUser1 = new MangoUser();
//        mangoUser1.setUserOpenid(openid);
//
//        work.huangxin.mango.util.login.IsLogin isLogin = new work.huangxin.mango.util.login.IsLogin();
//        isLogin.setCode(500);
